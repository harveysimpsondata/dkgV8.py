...
def upload_knowledge_asset(dkg, batch_data):
    try:
...
if __name__ == '__main__':
    ...
    num_threads = 2  # Adjust this based on your system's capacity
    ...
    # Create the DKG instance outside the loop
    ...
    while True:
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=num_threads) as executor:
            ...
            for i in range(0, len(df), batch_size):
                ...
                # Submit batch to the executor for parallel execution
                futures.append(executor.submit(upload_knowledge_asset, dkg, batch_data))
