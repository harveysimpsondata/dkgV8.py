...
if __name__ == '__main__':
    ...
    while True:
        ...
        # Loop to create and upload knowledge assets
        for _ in range(1000):  # Create 10 knowledge assets (adjust as needed)
            ...
            # Step 4: Upload the knowledge asset without increasing the allowance again
            upload_knowledge_asset_without_increase(json_ld_data, dkg)
