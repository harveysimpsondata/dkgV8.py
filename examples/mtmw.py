...
# Function to upload knowledge assets using the DKG without increasing the allowance
def upload_knowledge_asset_without_increase(json_ld_data, private_key):
    try:
...
if __name__ == '__main__':
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=num_threads) as executor:
        while True:
            ...
            for _ in range(1000):  # Create 1000 knowledge assets
                ...
                futures.append(executor.submit(upload_knowledge_asset_without_increase, json_ld_data, private_key))
