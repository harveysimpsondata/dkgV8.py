...
if __name__ == '__main__':
    ...
    # Loop to create and upload one knowledge asset at a time
    for _ in range(10):  # Create 10 knowledge assets (you can adjust this)
        ...
        # # Step 4: Upload the knowledge asset to the DKG
        upload_knowledge_asset(json_ld_data)
